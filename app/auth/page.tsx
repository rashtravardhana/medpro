    ...
    <div className="min-h-screen flex items-center justify-center bg-white text-black">
      ...
      <div className="w-full max-w-md p-8 border rounded-xl shadow">
        ...
        <input
          ...
          className="w-full border p-3 rounded mb-4 text-black placeholder:text-gray-500"
          value={name}
        ...
        <input
          ...
          className="w-full border p-3 rounded mb-6 text-black placeholder:text-gray-500"
          value={password}
